public enum Requisition
{
    ...
    CONTROL_ASK_CONTROL_PROCESS, RESPONSE_CONTROL_PROCESS,

    CONTROL_GET_CONTROL_VIEW_ADDRESS, RESPONSE_CONTROL_VIEW_ADDRESS,

    CONTROL_SEND_ROOM_CONTROL, CONTROL_REPONSE_RECEIVE_ROOM,

    VIEW_REQUEST_HISTORY, CONTROL_RESPONSE_HISTORY,

    CONTROL_REQUEST_HISTORY, MODEL_RESPONSE_HISTORY
}
